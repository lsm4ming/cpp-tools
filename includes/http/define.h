...
namespace cpptools::http
{
    ...
    using Header = cpptools::common::SortMap<String, Vector<String>>;
    ...
    {
    public:
        HttpStatusException(HttpStatus status) : status_(status) {}
    ...
    inline cpptools::common::HashMap<HttpStatus, String> statusMap =
        {
    ...
    String statusToString(HttpStatus status)
    {
